 ...
 * @author leobel
 */
public class DTGroupEditTest extends FunctionalTestBase {
    ...
    public void test(){
        ...
        Kebab kebab = Utils.getKebabOnTable(dtGroupsPage.getGroupsTable(), "Code", "administrators", "button");
        ...
        String pageName = Utils.getValue(driver, dtGroupEditPage.getName());
        String pageCode = Utils.getValue(driver, dtGroupEditPage.getCode());
