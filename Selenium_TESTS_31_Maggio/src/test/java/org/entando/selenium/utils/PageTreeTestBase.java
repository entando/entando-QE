...
public class PageTreeTestBase extends ExpandableTableTestTypology{
    ...
    //Owner group name
    public final String ownerGroupName = "SeleniumTest";
    //Join Group name
    public final String joinGroupName = "SeleniumTest";
    //Page model name
    public final String pageModelName = "Cagliari";
    //Default Charset
    ...
    /**
     * This is a helper method that creates a standard page to be used in these in tests
            ...
            throws InterruptedException
    {
        ...
        //Return back
        Assert.assertTrue(dTPageTreeAddPage.getSaveButton().isEnabled());
    ...
    /**
     * This is a helper method that delete a page to be used in these in tests
