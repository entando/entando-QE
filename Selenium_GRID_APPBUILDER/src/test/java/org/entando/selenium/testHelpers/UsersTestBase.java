...
public class UsersTestBase extends BrowsableTableTestTypology{
    ...
    public static final List<String> usersTableHeaderTitles = Arrays.asList("Username", "Full Name", "Email", "Status", "Actions");
    
    //Expected roles table header titles
    public static final List<String> rolesTableHeaderTitles = Arrays.asList("Name", "Code", "Actions");
    
    //Expected profile type table header titles
    public static final List<String> profileTypeTableHeaderTitles = Arrays.asList("Name", "Code", "Status",  "Actions");
    
    //Expected groups table header titles
    public static final List<String>groupsTableHeaderTitles = Arrays.asList("Name", "Code", "Actions");
    
    //Undefined option of Select
    public static final String undefinedOption = "Choose an option";
        
    //Default profileType
    public static final String profileType = "1SeleniumTest_DontTouch";
    
    //Default status
    public static final Boolean status = true;
    
    //Default minimum password length
    public static final double minPasswordLength = 8;
    
    //Default User Group
    public static final String userGroup = "1SeleniumTest_DontTouch";
            
    //Default User Role
    public static final String userRole = "1SeleniumTest_DontTouch";
    
    //Profile code to set
    public static final String profileTypeCode = "QZX";

    public UsersTestBase(String browserName, String platformName) {
    ...
    public boolean addUser(DTUsersPage dTUsersPage, DTUserAddPage dTUserAddPage, String username){
        ...
        return this.addUser(dTUsersPage, dTUserAddPage, username, password, profileType, status);
    }
    ...
    public boolean addRole(DTUserRolesPage dTUserRolesPage, DTUserRoleAddPage dTUserRoleAddPage, String roleName){
        ...
        dTUserRoleAddPage.setCodeField(roleName.substring(0, length).toLowerCase());
    ...
    {
        return this.addProfileType(dTUserProfileTypePage, dTUserProfileTypeAddPage,
    ...
    public boolean deleteGroup(DTUserGroupsPage dTUserGroupsPage, String groupName) throws InterruptedException{
        ...
        Utils.waitUntilIsDisappears(driver, DTUsersPage.modalWindowTag);
        sleep(200);
        /** Debug code **/ Logger.getGlobal().info("delete user group return true");        
        return true;
    }
