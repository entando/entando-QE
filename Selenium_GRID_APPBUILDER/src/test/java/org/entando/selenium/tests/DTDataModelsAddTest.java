...
public class DTDataModelsAddTest extends DataModelsTestBase {
    ...
    public DTDataModelsAddTest(String browserName, String platformName) {
    ...
    */
    ...
    public void runTest() throws InterruptedException, IOException {
        ...
        */
        ...
        DTDataModelsPage dTDataModelsPage = new DTDataModelsPage (driver);
        DTDataModelsAddPage dTDataModelsAddPage = new DTDataModelsAddPage (driver);
        ...
        */
        ...
        /**
         * This is an attempt at implementation of http API request
         **/
