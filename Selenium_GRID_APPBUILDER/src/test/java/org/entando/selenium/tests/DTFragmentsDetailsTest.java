...
public class DTFragmentsDetailsTest extends FragmentsTestBase{
    ...
    public DTFragmentsDetailsTest(String browserName, String platformName) {
    ...
    */
    ...
    public void runTest() throws InterruptedException{
        ...
        */
        ...
        DTFragmentNewPage dTFragmentNewPage = new DTFragmentNewPage(driver);
        DTFragmentsDetailsPage dTFragmentDetailsPage = new DTFragmentsDetailsPage(driver);
