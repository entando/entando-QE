...
public class DTCategoriesDetailsTest extends CategoriesTestBase{
    ...
    public DTCategoriesDetailsTest(String browserName, String platformName) {
    ...
    */  
    ...
    public void runTest() throws InterruptedException {
        ...
        */
        ...
        DTCategoriesDetailsPage dTCategoriesDetailsPage = new DTCategoriesDetailsPage(driver);
