...
public class PageTreeTestBase extends ExpandableTableTestTypology{
    ...
    public static final List<String> headerTitles = Arrays.asList("Page tree", "Status", "Displayed in menu", "Actions");
    //Owner group name
    ...
    //Constructor
    public PageTreeTestBase(String browserName, String platformName) {
