...
public class PageModelsTestBase extends BrowsableTableTestTypology{
    ...
    public static final List<String> expectedHeaderTitles = 
    ...
    //Constructor
    public PageModelsTestBase(String browserName, String platformName) {
    ...
    public boolean addPageModel(DTPageModelsPage dTPageModelsPage,
            DTPageModelsAddPage dTPageModelsAddPage) throws InterruptedException{
