 ...
 *
 */
public class STLogIntoEngineWithAdminUserTest extends UsersTestBase {
    ...
    */
    ...
    @Tag("login-tests")
    @Test
    public void loginOnEngine() throws InterruptedException {
        driver.manage().window().maximize();
        stEngineLoginPage.logIn(SmokeTestUser.ADMIN);
        //Navigation to the page
        WaitUntil.isVisible(driver, new By.ByLinkText("Add User"));
    }
}//end class
