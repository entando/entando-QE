...
/**
 * This class represent the User Roles page
 * 
 * @version 1.01
 */
public class DTUserRolesPage extends PageObject implements BrowsableTablePageInterface{
    ...
    public DTUserRolesPage(WebDriver driver) {
        super(driver);
    }
}
