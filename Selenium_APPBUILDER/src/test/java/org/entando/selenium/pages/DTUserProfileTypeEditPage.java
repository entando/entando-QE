...
/**
 * This class represent the Edit User Profile Type page
 * 
 * @version 1.01
 */
public class DTUserProfileTypeEditPage extends PageObject {
    ...
    public DTUserProfileTypeEditPage(WebDriver driver) {
        super(driver);
    }
}
