...
/**
 * This class prepresent the Data Models page object
 * 
 * @version 1.01
 */
public class DTDataModelsPage extends PageObject implements BrowsableTablePageInterface{
    ...
    @FindBy(xpath = "//button[contains(@id, 'DeleteDataModelModal__button-delete')]")
    ...
    private WebElement typeSearchSelect;
    ...
    public DTDataModelsPage(WebDriver driver) {
        super(driver);
    }
    ...
    public WebElement getTypeSearch() {
        return typeSearchSelect;
    }
    
    public Select getTypeSearchSelect() {
        return new Select(typeSearchSelect);
    }
    
    public void setTypeSearchSelect(String value) {
        this.getTypeSearchSelect().selectByVisibleText(value);
    }
