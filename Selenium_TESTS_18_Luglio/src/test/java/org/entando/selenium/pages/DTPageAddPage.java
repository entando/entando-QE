...
/**
 * This class represent the PageTree Add page
 * 
 * @version 1.01
 */
public class DTPageAddPage extends PageObject implements ExpandableTablePageInterface{
    ...
    public DTPageAddPage(WebDriver driver) {
       super(driver);
    }
    ...
    public Select getOwnerGroup() {
        return new Select(ownerGroup);
    }
